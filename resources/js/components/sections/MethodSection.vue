    ...
    <section ref="sectionRef" class="will-fade-in relative overflow-hidden bg-agency-cream py-20 md:py-32">
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-6">
            ...
            <div class="relative">
                ...
                <div class="absolute left-1/2 top-0 hidden h-full w-1 -translate-x-1/2 bg-gradient-to-b from-agency-electric via-agency-neon to-agency-electric md:block"></div>
                    ...
                    >
                        <div class="grid grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-16">
                            ...
                            >
                                <div
                                    :class="[
                                        'relative overflow-hidden rounded-2xl border border-agency-navy/10 bg-white p-8 shadow-lg transition-all duration-500 hover:shadow-2xl',
                                        index % 2 === 0 ? 'md:ml-auto hover:-translate-x-2' : 'md:mr-auto hover:translate-x-2'
                                    ]"
                                >
                                    <!-- Content -->
                                    ...
                                    <div
                                        :class="[
                                            'absolute top-1/2 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white shadow-lg md:flex',
                                            index % 2 === 0 ? '-right-6' : '-left-6'
                                        ]"
                                    >
                                        <div class="h-3 w-3 rounded-full bg-gradient-to-br from-agency-electric to-agency-neon"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                >
                                    <span class="font-serif text-9xl font-bold text-black">
                                        {{ step.number }}
                                    </span>
                                </div>
                            </div>
